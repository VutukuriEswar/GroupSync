...
import { Loader2, Sparkles, MapPin, DollarSign, Clock, RefreshCw, ThumbsUp } from 'lucide-react';
...
const RecommendationsPage = () => {
  ...
  const totalTime = recommendation?.schedule.reduce((sum, act) => sum + act.duration_minutes, 0) || 0;
  const totalCost = recommendation?.schedule.reduce((sum, act) => sum + act.estimated_cost, 0) || 0;
      ...
      <div className="max-w-5xl mx-auto py-8">
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            <Card className="glass">
              <CardContent className="pt-6">
                ...
                <p className="text-2xl font-bold" data-testid="activity-count">{recommendation?.schedule.length}</p>
          ...
          <div className="space-y-4 mb-8">
            ...
            <AnimatePresence>
              {recommendation?.schedule.map((activity, idx) => (
                <motion.div
                  key={idx}
            ...
            <Dialog open={showReplanDialog} onOpenChange={setShowReplanDialog}>
              ...
              <DialogContent>
                ...
                <div className="space-y-4 mt-4">
                  <Textarea
                    placeholder="E.g., 'Add more outdoor activities' or 'Replace the movie with something active'"
                    value={adjustment}
